    ...
    public partial class First : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Locations", x => x.WarehouseNumber);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationWarehouseNumber = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Products_CategoryOfProducts_CategoryOfProductId",
                        column: x => x.CategoryOfProductId,
                        principalTable: "CategoryOfProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_Locations_LocationWarehouseNumber",
                        column: x => x.LocationWarehouseNumber,
                        principalTable: "Locations",
                        principalColumn: "WarehouseNumber",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_LocationWarehouseNumber",
                table: "Products",
                column: "LocationWarehouseNumber");
